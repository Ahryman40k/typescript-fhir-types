...
usedMoney: RTTI_Money
        ...
        export var RTTI_ExplanationOfBenefit_Financial:any = t.intersection([mandatory, partial]);
        

export type IExplanationOfBenefit_Financial = t.TypeOf<typeof RTTI_ExplanationOfBenefit_Financial>;
