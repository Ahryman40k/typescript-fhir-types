...
import {RTTI_DataRequirement_CodeFilter, IDataRequirement_CodeFilter} from './RTTI_DataRequirement_CodeFilter';
import {RTTI_DataRequirement_DateFilter, IDataRequirement_DateFilter} from './RTTI_DataRequirement_DateFilter';
import {RTTI_DataRequirement_Sort, IDataRequirement_Sort} from './RTTI_DataRequirement_Sort';
...
The value of mustSupport SHALL be a FHIRPath resolveable on the type of the DataRequirement. The path SHALL consist only of identifiers, constant indexers, and .resolve() (see the [Simple FHIRPath Profile](fhirpath.html#simple) for full details).
        ...
        export const RTTI_DataRequirement: t.Type<IDataRequirement> = t.recursion( 'IDataRequirement', () =>
