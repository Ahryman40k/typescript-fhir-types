...
import { RTTI_AdverseEvent_SuspectEntity, IAdverseEvent_SuspectEntity } from './RTTI_AdverseEvent_SuspectEntity';
...
export const RTTI_AdverseEvent: t.Type<IAdverseEvent> = t.recursion('IAdverseEvent', () =>
    t.intersection([
