...
import {RTTI_EntryDefinition_RelatedEntry, IEntryDefinition_RelatedEntry} from './RTTI_EntryDefinition_RelatedEntry';
...
Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
                     ...
                     */
                    relatedEntry? : IEntryDefinition_RelatedEntry[];
                    
            }
        


        export const RTTI_EntryDefinition: t.Type<IEntryDefinition> = t.recursion( 'IEntryDefinition', () =>
            t.intersection([
                
        t.type({
           resourceType: t.literal('EntryDefinition'),
