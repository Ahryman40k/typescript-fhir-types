...
import {RTTI_ProcessResponse_ProcessNote, IProcessResponse_ProcessNote} from './RTTI_ProcessResponse_ProcessNote';
...
Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
                     ...
                     */
                    processNote? : IProcessResponse_ProcessNote[];
        ...
        export const RTTI_ProcessResponse: t.Type<IProcessResponse> = t.recursion( 'IProcessResponse', () =>
            t.intersection([
                
        t.type({
           resourceType: t.literal('ProcessResponse')
        })
        ,
