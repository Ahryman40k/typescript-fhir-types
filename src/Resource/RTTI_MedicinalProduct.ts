...
import { RTTI_MedicinalProduct_Name, IMedicinalProduct_Name } from './RTTI_MedicinalProduct_Name';
import { RTTI_MedicinalProduct_ManufacturingBusinessOperation, IMedicinalProduct_ManufacturingBusinessOperation } from './RTTI_MedicinalProduct_ManufacturingBusinessOperation';
import { RTTI_MedicinalProduct_SpecialDesignation, IMedicinalProduct_SpecialDesignation } from './RTTI_MedicinalProduct_SpecialDesignation';
...
export const RTTI_MedicinalProduct: t.Type<IMedicinalProduct> = t.recursion('IMedicinalProduct', () =>
    t.intersection([
