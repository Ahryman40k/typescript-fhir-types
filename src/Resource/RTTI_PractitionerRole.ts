...
import {RTTI_PractitionerRole_AvailableTime, IPractitionerRole_AvailableTime} from './RTTI_PractitionerRole_AvailableTime';
import {RTTI_PractitionerRole_NotAvailable, IPractitionerRole_NotAvailable} from './RTTI_PractitionerRole_NotAvailable';
...
Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
        ...
        export const RTTI_PractitionerRole: t.Type<IPractitionerRole> = t.recursion( 'IPractitionerRole', () =>
            t.intersection([
