...
import {RTTI_ExplanationOfBenefit_SubDetail} from './RTTI_ExplanationOfBenefit_SubDetail';
...
subDetail: t.array(RTTI_ExplanationOfBenefit_SubDetail)
        ...
        export var RTTI_ExplanationOfBenefit_Detail:any = t.intersection([mandatory, partial]);
        

export type IExplanationOfBenefit_Detail = t.TypeOf<typeof RTTI_ExplanationOfBenefit_Detail>;
