...
valueDosage: RTTI_Dosage
        ...
        export var RTTI_ElementDefinition_Example:any = t.intersection([mandatory, partial]);
        

export type IElementDefinition_Example = t.TypeOf<typeof RTTI_ElementDefinition_Example>;
