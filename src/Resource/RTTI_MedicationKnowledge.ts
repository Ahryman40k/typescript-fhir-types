...
import {RTTI_MedicationKnowledge_RelatedMedicationKnowledge, IMedicationKnowledge_RelatedMedicationKnowledge} from './RTTI_MedicationKnowledge_RelatedMedicationKnowledge';
import {RTTI_MedicationKnowledge_Monograph, IMedicationKnowledge_Monograph} from './RTTI_MedicationKnowledge_Monograph';
import {RTTI_MedicationKnowledge_Ingredient, IMedicationKnowledge_Ingredient} from './RTTI_MedicationKnowledge_Ingredient';
import {RTTI_MedicationKnowledge_Cost, IMedicationKnowledge_Cost} from './RTTI_MedicationKnowledge_Cost';
import {RTTI_MedicationKnowledge_MonitoringProgram, IMedicationKnowledge_MonitoringProgram} from './RTTI_MedicationKnowledge_MonitoringProgram';
import {RTTI_MedicationKnowledge_AdministrationGuidelines, IMedicationKnowledge_AdministrationGuidelines} from './RTTI_MedicationKnowledge_AdministrationGuidelines';
import {RTTI_MedicationKnowledge_MedicineClassification, IMedicationKnowledge_MedicineClassification} from './RTTI_MedicationKnowledge_MedicineClassification';
import {RTTI_MedicationKnowledge_Packaging, IMedicationKnowledge_Packaging} from './RTTI_MedicationKnowledge_Packaging';
import {RTTI_MedicationKnowledge_DrugCharacteristic, IMedicationKnowledge_DrugCharacteristic} from './RTTI_MedicationKnowledge_DrugCharacteristic';
import {RTTI_MedicationKnowledge_Regulatory, IMedicationKnowledge_Regulatory} from './RTTI_MedicationKnowledge_Regulatory';
import {RTTI_MedicationKnowledge_Kinetics, IMedicationKnowledge_Kinetics} from './RTTI_MedicationKnowledge_Kinetics';
...
Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
        ...
        export const RTTI_MedicationKnowledge: t.Type<IMedicationKnowledge> = t.recursion( 'IMedicationKnowledge', () =>
            t.intersection([
