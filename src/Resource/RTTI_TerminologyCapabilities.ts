...
import {RTTI_TerminologyCapabilities_Software, ITerminologyCapabilities_Software} from './RTTI_TerminologyCapabilities_Software';
import {RTTI_TerminologyCapabilities_Implementation, ITerminologyCapabilities_Implementation} from './RTTI_TerminologyCapabilities_Implementation';
import {RTTI_TerminologyCapabilities_CodeSystem, ITerminologyCapabilities_CodeSystem} from './RTTI_TerminologyCapabilities_CodeSystem';
import {RTTI_TerminologyCapabilities_Expansion, ITerminologyCapabilities_Expansion} from './RTTI_TerminologyCapabilities_Expansion';
import {RTTI_TerminologyCapabilities_ValidateCode, ITerminologyCapabilities_ValidateCode} from './RTTI_TerminologyCapabilities_ValidateCode';
import {RTTI_TerminologyCapabilities_Translation, ITerminologyCapabilities_Translation} from './RTTI_TerminologyCapabilities_Translation';
import {RTTI_TerminologyCapabilities_Closure, ITerminologyCapabilities_Closure} from './RTTI_TerminologyCapabilities_Closure';
...
Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
        ...
        export const RTTI_TerminologyCapabilities: t.Type<ITerminologyCapabilities> = t.recursion( 'ITerminologyCapabilities', () =>
            t.intersection([
