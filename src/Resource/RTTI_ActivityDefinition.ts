...
import { RTTI_ActivityDefinition_Participant, IActivityDefinition_Participant } from './RTTI_ActivityDefinition_Participant';
import { RTTI_Quantity, IQuantity } from './RTTI_Quantity';
import { RTTI_Dosage, IDosage } from './RTTI_Dosage';
import { RTTI_ActivityDefinition_DynamicValue, IActivityDefinition_DynamicValue } from './RTTI_ActivityDefinition_DynamicValue';
...
export const RTTI_ActivityDefinition: t.Type<IActivityDefinition> = t.recursion('IActivityDefinition', () =>
    t.intersection([
