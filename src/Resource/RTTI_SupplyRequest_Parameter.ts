...
_valueBoolean: RTTI_Element
        ...
        export var RTTI_SupplyRequest_Parameter:any = t.intersection([mandatory, partial]);
        

export type ISupplyRequest_Parameter = t.TypeOf<typeof RTTI_SupplyRequest_Parameter>;
