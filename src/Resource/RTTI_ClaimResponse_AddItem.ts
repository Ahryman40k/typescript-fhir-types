...
import {RTTI_ClaimResponse_Detail1} from './RTTI_ClaimResponse_Detail1';
...
detail: t.array(RTTI_ClaimResponse_Detail1)
        ...
        export var RTTI_ClaimResponse_AddItem:any = t.intersection([mandatory, partial]);
        

export type IClaimResponse_AddItem = t.TypeOf<typeof RTTI_ClaimResponse_AddItem>;
