...
import {RTTI_PlanDefinition_Goal} from './RTTI_PlanDefinition_Goal';
import {RTTI_PlanDefinition_Action} from './RTTI_PlanDefinition_Action';
...
action: t.array(RTTI_PlanDefinition_Action)
        ...
        export var RTTI_PlanDefinition:any = t.intersection([mandatory, partial]);
        

export type IPlanDefinition = t.TypeOf<typeof RTTI_PlanDefinition>;
