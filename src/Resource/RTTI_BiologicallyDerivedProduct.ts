...
import { RTTI_BiologicallyDerivedProduct_Collection, IBiologicallyDerivedProduct_Collection } from './RTTI_BiologicallyDerivedProduct_Collection';
import { RTTI_BiologicallyDerivedProduct_Processing, IBiologicallyDerivedProduct_Processing } from './RTTI_BiologicallyDerivedProduct_Processing';
import { RTTI_BiologicallyDerivedProduct_Manipulation, IBiologicallyDerivedProduct_Manipulation } from './RTTI_BiologicallyDerivedProduct_Manipulation';
import { RTTI_BiologicallyDerivedProduct_Storage, IBiologicallyDerivedProduct_Storage } from './RTTI_BiologicallyDerivedProduct_Storage';
...
export const RTTI_BiologicallyDerivedProduct: t.Type<IBiologicallyDerivedProduct> = t.recursion('IBiologicallyDerivedProduct', () =>
    t.intersection([
