...
adjudication: t.array(RTTI_ClaimResponse_Adjudication)
        ...
        export var RTTI_ClaimResponse_SubDetail1:any = t.intersection([mandatory, partial]);
        

export type IClaimResponse_SubDetail1 = t.TypeOf<typeof RTTI_ClaimResponse_SubDetail1>;
