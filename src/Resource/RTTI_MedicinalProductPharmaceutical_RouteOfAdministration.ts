...
import {RTTI_MedicinalProductPharmaceutical_TargetSpecies, IMedicinalProductPharmaceutical_TargetSpecies} from './RTTI_MedicinalProductPharmaceutical_TargetSpecies';
...
Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
        ...
        export const RTTI_MedicinalProductPharmaceutical_RouteOfAdministration: t.Type<IMedicinalProductPharmaceutical_RouteOfAdministration> = t.recursion( 'IMedicinalProductPharmaceutical_RouteOfAdministration', () =>
            t.intersection([
