...
item: t.array(RTTI_QuestionnaireResponse_Item)
        ...
        export var RTTI_QuestionnaireResponse_Answer:any = t.intersection([mandatory, partial]);
        

export type IQuestionnaireResponse_Answer = t.TypeOf<typeof RTTI_QuestionnaireResponse_Answer>;
