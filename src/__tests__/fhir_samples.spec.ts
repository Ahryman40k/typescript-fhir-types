...
import {
    RTTI_Account, RTTI_AdverseEvent, RTTI_AllergyIntolerance, RTTI_AppointmentResponse, RTTI_Appointment, RTTI_AuditEvent,
    RTTI_Basic, RTTI_Binary, RTTI_CapabilityStatement, RTTI_Bundle, RTTI_CarePlan, RTTI_Claim, 
    RTTI_ActivityDefinition, RTTI_CodeSystem, RTTI_BodyStructure, RTTI_BiologicallyDerivedProduct, RTTI_CareTeam, RTTI_ChargeItem, RTTI_ChargeItemDefinition, RTTI_ClaimResponse, RTTI_ClinicalImpression, RTTI_Communication, RTTI_CommunicationRequest, RTTI_CompartmentDefinition, RTTI_Composition, RTTI_ConceptMap, RTTI_Condition, RTTI_Consent, RTTI_Contract, RTTI_Coverage, RTTI_CoverageEligibilityRequest, RTTI_CoverageEligibilityResponse, RTTI_DetectedIssue, RTTI_Device,
