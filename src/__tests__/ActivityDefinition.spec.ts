import * as zika_virus from './samples/activitydefinition/activitydefinition-administer-zika-virus-exposure-assessment.json';
import * as example from './samples/activitydefinition/activitydefinition-example.json';
import * as medicationorder from './samples/activitydefinition/activitydefinition-medicationorder-example.json';
import * as order_serum_dengue from './samples/activitydefinition/activitydefinition-order-serum-dengue-virus-igm.json';
import * as order_serum_zika from './samples/activitydefinition/activitydefinition-order-serum-zika-dengue-virus-igm.json';
import * as predecessor from './samples/activitydefinition/activitydefinition-predecessor-example.json';
import * as mosquito_prevention from './samples/activitydefinition/activitydefinition-provide-mosquito-prevention-advice.json';
import * as servicerequest from './samples/activitydefinition/activitydefinition-servicerequest-example.json';
import * as supplyrequest from './samples/activitydefinition/activitydefinition-supplyrequest-example.json';
