...
import { RTTI_ChargeItemDefinition_PropertyGroup, IChargeItemDefinition_PropertyGroup } from './RTTI_ChargeItemDefinition_PropertyGroup';
...
export const RTTI_ChargeItemDefinition: t.Type<IChargeItemDefinition> = t.recursion('IChargeItemDefinition', () =>
    t.intersection([
