...
import { RTTI_Coverage_Exception, ICoverage_Exception } from './RTTI_Coverage_Exception';
...
export const RTTI_Coverage_CostToBeneficiary: t.Type<ICoverage_CostToBeneficiary> = t.recursion('ICoverage_CostToBeneficiary', () =>
