...
import { RTTI_SubstanceNucleicAcid_Subunit, ISubstanceNucleicAcid_Subunit } from './RTTI_SubstanceNucleicAcid_Subunit';
...
export const RTTI_SubstanceNucleicAcid: t.Type<ISubstanceNucleicAcid> = t.recursion('ISubstanceNucleicAcid', () =>
    t.intersection([
