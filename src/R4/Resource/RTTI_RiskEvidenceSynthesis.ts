...
import {RTTI_RiskEvidenceSynthesis_SampleSize, IRiskEvidenceSynthesis_SampleSize} from './RTTI_RiskEvidenceSynthesis_SampleSize';
import {RTTI_RiskEvidenceSynthesis_RiskEstimate, IRiskEvidenceSynthesis_RiskEstimate} from './RTTI_RiskEvidenceSynthesis_RiskEstimate';
import {RTTI_RiskEvidenceSynthesis_Certainty, IRiskEvidenceSynthesis_Certainty} from './RTTI_RiskEvidenceSynthesis_Certainty';
...
Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
        ...
        export const RTTI_RiskEvidenceSynthesis: t.Type<IRiskEvidenceSynthesis> = t.recursion( 'IRiskEvidenceSynthesis', () =>
            t.intersection([
...
title: t.string,
_title: RTTI_Element,
status: createEnumType<RiskEvidenceSynthesisStatusKind>(RiskEvidenceSynthesisStatusKind, 'RiskEvidenceSynthesisStatusKind'),
