...
import {RTTI_SubstancePolymer_MonomerSet, ISubstancePolymer_MonomerSet} from './RTTI_SubstancePolymer_MonomerSet';
import {RTTI_SubstancePolymer_Repeat, ISubstancePolymer_Repeat} from './RTTI_SubstancePolymer_Repeat';
...
Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
        ...
        export const RTTI_SubstancePolymer: t.Type<ISubstancePolymer> = t.recursion( 'ISubstancePolymer', () =>
            t.intersection([
