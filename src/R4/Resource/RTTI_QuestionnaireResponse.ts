...
import { RTTI_QuestionnaireResponse_Item, IQuestionnaireResponse_Item } from './RTTI_QuestionnaireResponse_Item';
...
export const RTTI_QuestionnaireResponse: t.Type<IQuestionnaireResponse> = t.recursion('IQuestionnaireResponse', () =>
    t.intersection([
        ...
        t.partial({
            ...
            status: createEnumType<QuestionnaireResponseStatusKind>(QuestionnaireResponseStatusKind, 'QuestionnaireResponseStatusKind'),
