...
import { RTTI_MeasureReport_Group, IMeasureReport_Group } from './RTTI_MeasureReport_Group';
...
export const RTTI_MeasureReport: t.Type<IMeasureReport> = t.recursion('IMeasureReport', () =>
    t.intersection([
        ...
        t.partial({
            ...
            status: createEnumType<MeasureReportStatusKind>(MeasureReportStatusKind, 'MeasureReportStatusKind'),
            _status: RTTI_Element,
            type: createEnumType<MeasureReportTypeKind>(MeasureReportTypeKind, 'MeasureReportTypeKind'),
            _type: RTTI_Element,
