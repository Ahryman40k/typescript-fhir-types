...
import { RTTI_TestReport_Participant, ITestReport_Participant } from './RTTI_TestReport_Participant';
import { RTTI_TestReport_Setup, ITestReport_Setup } from './RTTI_TestReport_Setup';
import { RTTI_TestReport_Test, ITestReport_Test } from './RTTI_TestReport_Test';
import { RTTI_TestReport_Teardown, ITestReport_Teardown } from './RTTI_TestReport_Teardown';
...
export const RTTI_TestReport: t.Type<ITestReport> = t.recursion('ITestReport', () =>
    t.intersection([
        ...
        t.partial({
            ...
            name: t.string,
            _name: RTTI_Element,
            status: createEnumType<TestReportStatusKind>(TestReportStatusKind, 'TestReportStatusKind'),
            _status: RTTI_Element,
            result: createEnumType<TestReportResultKind>(TestReportResultKind, 'TestReportResultKind'),
