...
import { RTTI_Communication_Payload, ICommunication_Payload } from './RTTI_Communication_Payload';
...
export const RTTI_Communication: t.Type<ICommunication> = t.recursion('ICommunication', () =>
    t.intersection([
