...
export const RTTI_PlanDefinition_Action: t.Type<IPlanDefinition_Action> = t.recursion('IPlanDefinition_Action', () =>
    ...
    t.partial({
        ...
        groupingBehavior: createEnumType<PlanDefinition_ActionGroupingBehaviorKind>(PlanDefinition_ActionGroupingBehaviorKind, 'PlanDefinition_ActionGroupingBehaviorKind'),
        _groupingBehavior: RTTI_Element,
        selectionBehavior: createEnumType<PlanDefinition_ActionSelectionBehaviorKind>(PlanDefinition_ActionSelectionBehaviorKind, 'PlanDefinition_ActionSelectionBehaviorKind'),
        _selectionBehavior: RTTI_Element,
        requiredBehavior: createEnumType<PlanDefinition_ActionRequiredBehaviorKind>(PlanDefinition_ActionRequiredBehaviorKind, 'PlanDefinition_ActionRequiredBehaviorKind'),
