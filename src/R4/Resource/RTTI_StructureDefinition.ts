...
export const RTTI_StructureDefinition: t.Type<IStructureDefinition> = t.recursion('IStructureDefinition', () =>
    t.intersection([
        ...
        t.partial({
            ...
            title: t.string,
            _title: RTTI_Element,
            status: createEnumType<StructureDefinitionStatusKind>(StructureDefinitionStatusKind, 'StructureDefinitionStatusKind'),
            ...
            kind: createEnumType<StructureDefinitionKindKind>(StructureDefinitionKindKind, 'StructureDefinitionKindKind'),
            _kind: RTTI_Element,
            abstract: t.boolean,
