...
import { RTTI_SupplyRequest_Parameter, ISupplyRequest_Parameter } from './RTTI_SupplyRequest_Parameter';
...
export const RTTI_SupplyRequest: t.Type<ISupplyRequest> = t.recursion('ISupplyRequest', () =>
    t.intersection([
