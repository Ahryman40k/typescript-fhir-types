...
export const RTTI_Questionnaire_EnableWhen: t.Type<IQuestionnaire_EnableWhen> = t.recursion('IQuestionnaire_EnableWhen', () =>
        ...
        t.partial({
                ...
                operator: createEnumType<Questionnaire_EnableWhenOperatorKind>(Questionnaire_EnableWhenOperatorKind, 'Questionnaire_EnableWhenOperatorKind'),
