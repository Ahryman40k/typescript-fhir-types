...
export const RTTI_VisionPrescription_LensSpecification: t.Type<IVisionPrescription_LensSpecification> = t.recursion('IVisionPrescription_LensSpecification', () =>
    t.intersection([
        ...
        t.partial({
            ...
            eye: createEnumType<VisionPrescription_LensSpecificationEyeKind>(VisionPrescription_LensSpecificationEyeKind, 'VisionPrescription_LensSpecificationEyeKind'),
            _eye: RTTI_Element,
            sphere: t.number,
