...
import { RTTI_EvidenceVariable_Characteristic, IEvidenceVariable_Characteristic } from './RTTI_EvidenceVariable_Characteristic';
...
export const RTTI_EvidenceVariable: t.Type<IEvidenceVariable> = t.recursion('IEvidenceVariable', () =>
    t.intersection([
        ...
        t.partial({
            ...
            status: createEnumType<EvidenceVariableStatusKind>(EvidenceVariableStatusKind, 'EvidenceVariableStatusKind'),
            ...
            type: createEnumType<EvidenceVariableTypeKind>(EvidenceVariableTypeKind, 'EvidenceVariableTypeKind'),
            _type: RTTI_Element
        })
