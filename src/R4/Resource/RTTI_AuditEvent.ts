...
import { RTTI_AuditEvent_Agent, IAuditEvent_Agent } from './RTTI_AuditEvent_Agent';
import { RTTI_AuditEvent_Source, IAuditEvent_Source } from './RTTI_AuditEvent_Source';
...
const AuditEventOutcomeKindKeys = t.keyof({
    [AuditEventOutcomeKind.Success]: null,
    [AuditEventOutcomeKind.MinorFailure]: null,
    [AuditEventOutcomeKind.SeriousFailure]: null,
    [AuditEventOutcomeKind.MajorFailure]: null
});
...
export const RTTI_AuditEvent: t.Type<IAuditEvent> = t.recursion('IAuditEvent', () =>
    t.intersection([
