...
export const RTTI_CapabilityStatement_Interaction1: t.Type<ICapabilityStatement_Interaction1> = t.recursion('ICapabilityStatement_Interaction1', () =>

        t.partial({
                id: t.string,
                extension: t.array(RTTI_Extension),
                modifierExtension: t.array(RTTI_Extension),
                code: createEnumType<CapabilityStatement_Interaction1CodeKind>(CapabilityStatement_Interaction1CodeKind, 'CapabilityStatement_Interaction1CodeKind'),
                _code: RTTI_Element,
