...
Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
        ...
        export const RTTI_MedicinalProductIngredient_ReferenceStrength: t.Type<IMedicinalProductIngredient_ReferenceStrength> = t.recursion( 'IMedicinalProductIngredient_ReferenceStrength', () =>
            t.intersection([
