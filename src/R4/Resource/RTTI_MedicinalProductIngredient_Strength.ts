...
import {RTTI_MedicinalProductIngredient_ReferenceStrength, IMedicinalProductIngredient_ReferenceStrength} from './RTTI_MedicinalProductIngredient_ReferenceStrength';
...
Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
        ...
        export const RTTI_MedicinalProductIngredient_Strength: t.Type<IMedicinalProductIngredient_Strength> = t.recursion( 'IMedicinalProductIngredient_Strength', () =>
            t.intersection([
