...
import { RTTI_ChargeItem_Performer, IChargeItem_Performer } from './RTTI_ChargeItem_Performer';
...
export const RTTI_ChargeItem: t.Type<IChargeItem> = t.recursion('IChargeItem', () =>
    t.intersection([
