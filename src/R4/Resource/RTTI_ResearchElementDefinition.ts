...
import { RTTI_ResearchElementDefinition_Characteristic, IResearchElementDefinition_Characteristic } from './RTTI_ResearchElementDefinition_Characteristic';
...
export const RTTI_ResearchElementDefinition: t.Type<IResearchElementDefinition> = t.recursion('IResearchElementDefinition', () =>
    t.intersection([
        ...
        t.partial({
            ...
            status: createEnumType<ResearchElementDefinitionStatusKind>(ResearchElementDefinitionStatusKind, 'ResearchElementDefinitionStatusKind'),
            ...
            type: createEnumType<ResearchElementDefinitionTypeKind>(ResearchElementDefinitionTypeKind, 'ResearchElementDefinitionTypeKind'),
            _type: RTTI_Element,
            variableType: createEnumType<ResearchElementDefinitionVariableTypeKind>(ResearchElementDefinitionVariableTypeKind, 'ResearchElementDefinitionVariableTypeKind'),
