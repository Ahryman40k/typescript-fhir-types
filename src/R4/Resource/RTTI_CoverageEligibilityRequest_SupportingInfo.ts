...
export const RTTI_CoverageEligibilityRequest_SupportingInfo: t.Type<ICoverageEligibilityRequest_SupportingInfo> = t.recursion('ICoverageEligibilityRequest_SupportingInfo', () =>
    t.intersection([
