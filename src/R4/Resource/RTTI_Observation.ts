...
import { RTTI_Observation_ReferenceRange, IObservation_ReferenceRange } from './RTTI_Observation_ReferenceRange';
import { RTTI_Observation_Component, IObservation_Component } from './RTTI_Observation_Component';
...
export const RTTI_Observation: t.Type<IObservation> = t.recursion('IObservation', () =>
    t.intersection([
        ...
        t.partial({
            ...
            status: createEnumType<ObservationStatusKind>(ObservationStatusKind, 'ObservationStatusKind'),
