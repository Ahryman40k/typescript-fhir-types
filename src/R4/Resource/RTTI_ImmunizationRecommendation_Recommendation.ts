...
import {RTTI_ImmunizationRecommendation_DateCriterion, IImmunizationRecommendation_DateCriterion} from './RTTI_ImmunizationRecommendation_DateCriterion';
...
Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
        ...
        export const RTTI_ImmunizationRecommendation_Recommendation: t.Type<IImmunizationRecommendation_Recommendation> = t.recursion( 'IImmunizationRecommendation_Recommendation', () =>
            t.intersection([
