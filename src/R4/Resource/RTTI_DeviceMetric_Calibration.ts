...
export const RTTI_DeviceMetric_Calibration: t.Type<IDeviceMetric_Calibration> = t.recursion('IDeviceMetric_Calibration', () =>
        ...
        t.partial({
                ...
                type: createEnumType<DeviceMetric_CalibrationTypeKind>(DeviceMetric_CalibrationTypeKind, 'DeviceMetric_CalibrationTypeKind'),
                _type: RTTI_Element,
                state: createEnumType<DeviceMetric_CalibrationStateKind>(DeviceMetric_CalibrationStateKind, 'DeviceMetric_CalibrationStateKind'),
                _state: RTTI_Element,
                time: t.string,
                _time: RTTI_Element
        })
