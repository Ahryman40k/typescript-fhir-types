...
import {RTTI_MolecularSequence_Roc, IMolecularSequence_Roc} from './RTTI_MolecularSequence_Roc';
...
Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
        ...
        export const RTTI_MolecularSequence_Quality: t.Type<IMolecularSequence_Quality> = t.recursion( 'IMolecularSequence_Quality', () =>
                
        t.partial({
            id: t.string,
extension: t.array(RTTI_Extension),
modifierExtension: t.array(RTTI_Extension),
type: createEnumType<MolecularSequence_QualityTypeKind>(MolecularSequence_QualityTypeKind, 'MolecularSequence_QualityTypeKind'),
_type: RTTI_Element,
