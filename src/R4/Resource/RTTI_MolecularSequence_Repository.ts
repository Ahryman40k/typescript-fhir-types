...
Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
        ...
        export const RTTI_MolecularSequence_Repository: t.Type<IMolecularSequence_Repository> = t.recursion( 'IMolecularSequence_Repository', () =>
                
        t.partial({
            id: t.string,
extension: t.array(RTTI_Extension),
modifierExtension: t.array(RTTI_Extension),
type: createEnumType<MolecularSequence_RepositoryTypeKind>(MolecularSequence_RepositoryTypeKind, 'MolecularSequence_RepositoryTypeKind'),
_type: RTTI_Element,
url: t.string,
_url: RTTI_Element,
name: t.string,
