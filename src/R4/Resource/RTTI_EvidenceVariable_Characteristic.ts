...
Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
        ...
        export const RTTI_EvidenceVariable_Characteristic: t.Type<IEvidenceVariable_Characteristic> = t.recursion( 'IEvidenceVariable_Characteristic', () =>
...
groupMeasure: createEnumType<EvidenceVariable_CharacteristicGroupMeasureKind>(EvidenceVariable_CharacteristicGroupMeasureKind, 'EvidenceVariable_CharacteristicGroupMeasureKind'),
