...
import { RTTI_SupplyDelivery_SuppliedItem, ISupplyDelivery_SuppliedItem } from './RTTI_SupplyDelivery_SuppliedItem';
...
export const RTTI_SupplyDelivery: t.Type<ISupplyDelivery> = t.recursion('ISupplyDelivery', () =>
    t.intersection([
        ...
        t.partial({
            ...
            status: createEnumType<SupplyDeliveryStatusKind>(SupplyDeliveryStatusKind, 'SupplyDeliveryStatusKind'),
