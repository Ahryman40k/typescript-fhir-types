...
} from '../Resource/RTTI_BiologicallyDerivedProduct';
import {
  RTTI_BodyStructure,
  IBodyStructure,
} from '../Resource/RTTI_BodyStructure';
import {RTTI_Bundle, IBundle} from '../Resource/RTTI_Bundle';
import {
  RTTI_CapabilityStatement,
  ICapabilityStatement,
} from '../Resource/RTTI_CapabilityStatement';
...
} from '../Resource/RTTI_CoverageEligibilityRequest';
import {
  RTTI_CoverageEligibilityResponse,
  ICoverageEligibilityResponse,
} from '../Resource/RTTI_CoverageEligibilityResponse';
import {
  RTTI_DetectedIssue,
  IDetectedIssue,
} from '../Resource/RTTI_DetectedIssue';
import {RTTI_Device, IDevice} from '../Resource/RTTI_Device';
import {
  RTTI_DeviceDefinition,
  IDeviceDefinition,
} from '../Resource/RTTI_DeviceDefinition';
import {RTTI_DeviceMetric, IDeviceMetric} from '../Resource/RTTI_DeviceMetric';
import {
  RTTI_DeviceRequest,
  IDeviceRequest,
} from '../Resource/RTTI_DeviceRequest';
import {
  RTTI_DeviceUseStatement,
  IDeviceUseStatement,
} from '../Resource/RTTI_DeviceUseStatement';
import {
  RTTI_DiagnosticReport,
  IDiagnosticReport,
} from '../Resource/RTTI_DiagnosticReport';
import {
  RTTI_DocumentManifest,
  IDocumentManifest,
} from '../Resource/RTTI_DocumentManifest';
import {
  RTTI_DocumentReference,
  IDocumentReference,
} from '../Resource/RTTI_DocumentReference';
...
} from '../Resource/RTTI_ImmunizationEvaluation';
import {
  RTTI_ImmunizationRecommendation,
  IImmunizationRecommendation,
} from '../Resource/RTTI_ImmunizationRecommendation';
import {
  RTTI_ImplementationGuide,
  IImplementationGuide,
} from '../Resource/RTTI_ImplementationGuide';
import {
  RTTI_InsurancePlan,
  IInsurancePlan,
} from '../Resource/RTTI_InsurancePlan';
...
import {
  RTTI_MeasureReport,
  IMeasureReport,
} from '../Resource/RTTI_MeasureReport';
...
import {
  RTTI_Questionnaire,
  IQuestionnaire,
} from '../Resource/RTTI_Questionnaire';
import {
  RTTI_QuestionnaireResponse,
  IQuestionnaireResponse,
} from '../Resource/RTTI_QuestionnaireResponse';
import {
  RTTI_RelatedPerson,
  IRelatedPerson,
} from '../Resource/RTTI_RelatedPerson';
import {RTTI_RequestGroup, IRequestGroup} from '../Resource/RTTI_RequestGroup';
import {
  RTTI_ResearchStudy,
  IResearchStudy,
} from '../Resource/RTTI_ResearchStudy';
import {
  RTTI_ResearchSubject,
  IResearchSubject,
} from '../Resource/RTTI_ResearchSubject';
import {
  RTTI_RiskAssessment,
  IRiskAssessment,
} from '../Resource/RTTI_RiskAssessment';
import {RTTI_Schedule, ISchedule} from '../Resource/RTTI_Schedule';
import {
  RTTI_SearchParameter,
  ISearchParameter,
} from '../Resource/RTTI_SearchParameter';
import {
  RTTI_ServiceRequest,
  IServiceRequest,
} from '../Resource/RTTI_ServiceRequest';
...
import {
  ...
  ISpecimenDefinition,
} from '../Resource/RTTI_SpecimenDefinition';
import {
  RTTI_StructureDefinition,
  IStructureDefinition,
} from '../Resource/RTTI_StructureDefinition';
...
import {
  ...
  ISubstancePolymer,
} from '../Resource/RTTI_SubstancePolymer';
import {
  RTTI_SubstanceReferenceInformation,
  ISubstanceReferenceInformation,
} from '../Resource/RTTI_SubstanceReferenceInformation';
import {
  RTTI_SubstanceSpecification,
  ISubstanceSpecification,
} from '../Resource/RTTI_SubstanceSpecification';
import {
  RTTI_SupplyDelivery,
  ISupplyDelivery,
} from '../Resource/RTTI_SupplyDelivery';
import {
  RTTI_SupplyRequest,
  ISupplyRequest,
} from '../Resource/RTTI_SupplyRequest';
import {RTTI_Task, ITask} from '../Resource/RTTI_Task';
import {
  RTTI_TerminologyCapabilities,
  ITerminologyCapabilities,
} from '../Resource/RTTI_TerminologyCapabilities';
...
import {
  ...
  IVerificationResult,
} from '../Resource/RTTI_VerificationResult';
import {
  RTTI_VisionPrescription,
  IVisionPrescription,
} from '../Resource/RTTI_VisionPrescription';
...
export const RTTI_ResourceList: t.Type<IResourceList> = t.recursion(
  'IResourceList',
  () =>
    t.union([
      RTTI_Account,
